...
List<Animal> AnonymoseObjects=[Dog(name: "WDog",age: 12 ,numberOfArmy: 4),Dog(name: "WDog",age: 12 ,numberOfArmy: 4)]; // this anonymous objects is object without reference accessed by list
